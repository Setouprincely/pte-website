        ...
        <section className="faq-hero">
          <div className="faq-hero-inner">
            <div className="faq-eyebrow">
              ...
              <span className="faq-eyebrow-text">Knowledge Base — EliteScore PTE</span>
            </div>
        ...
        <section className="faq-cta">
          <div className="faq-cta-inner">
            <div>
              ...
              <p>
                Speak directly with an EliteScore coach. We respond within minutes during business hours.
              </p>
            </div>
            <div className="faq-cta-btn-wrap">
              <WhatsAppButton size="lg" message="Hi, I have a few questions about your PTE programs">
